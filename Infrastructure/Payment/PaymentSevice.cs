...
using Stripe;
using Product = Domain.Entities.BusinessEntities.Product;
...
public class PaymentSevice : IPaymentService
{
    ...
    public PaymentSevice(IBasketRepository basketRepository, IUnitOfWork unitOfWork, IConfiguration configuration)
    {
