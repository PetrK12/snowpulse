...
namespace Persistence.Migrations
{
    ...
    [Migration("20240108192735_OrderEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BusinessEntities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.BusinessEntities.ProductBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entities.BusinessEntities.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entities.BusinessEntities.Product", b =>
                {
                    b.HasOne("Domain.Entities.BusinessEntities.ProductBrand", "ProductBrand")
                        .WithMany()
                        .HasForeignKey("ProductBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.BusinessEntities.ProductType", "ProductType")
                        .WithMany()
